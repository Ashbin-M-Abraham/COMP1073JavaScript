...
const person = {
    ...
    age: 20,
    interests: ['soccer', 'gaming', 'coding'],
    greeting() {
        // let greeting = `Hi, I am ${this.name.} and I am ${this.age} years old and i enjoy playing ${this.interests[0]}.`;
        // return greeting
        let greeting = `Hi, I am ${this.name.first} ${this.name.middle} ${this.name.last} and I am ${this.age} years old and i enjoy playing ${this.interests[0]}.`;
        return greeting 
    }
...
output.textContent = person.greeting(); // Call the method "greeting"
...
output.textContent =`${person.name.first} ${person.name.middle}. ${person.name.last}`;
